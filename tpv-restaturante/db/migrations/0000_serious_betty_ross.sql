...
CREATE INDEX "idx_webhook_events_status" ON "webhook_events" USING btree ("status" text_ops);--> statement-breakpoint
...
CREATE INDEX "idx_employees_tenant" ON "employees" USING btree ("tenant_id" text_ops);
*/