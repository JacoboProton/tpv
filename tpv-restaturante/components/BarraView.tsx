...
import { TICKET_EDGE, type Theme } from './constants';
...
interface BarraOrder {
  id: string;
  items: BarraItem[];
}

interface BarraTable {
  id: string;
  name: string;
  orderId: string;
}

interface BarraFloor {
  tables: BarraTable[];
...
export default function BarraView({ floor, onReady, colors: C }: BarraViewProps) {
