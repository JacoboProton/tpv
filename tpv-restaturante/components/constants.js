...
export function seedCatalog() {
  ...
  const products = [
    { id: 'p1',  name: 'Caña',              category: 'Bebidas',    price: 2.2,  stock: 80, lowStock: 15, ubicacion: 'Bar',     discount: 0, course: '', allergens: ['gluten'] },
    { id: 'p2',  name: 'Tinto de verano',   category: 'Bebidas',    price: 2.8,  stock: 40, lowStock: 10, ubicacion: 'Bar',     discount: 0, course: '', allergens: ['sulfitos'] },
    { id: 'p3',  name: 'Vermut',            category: 'Bebidas',    price: 3.2,  stock: 25, lowStock: 8,  ubicacion: 'Bar',     discount: 0, course: '', allergens: ['sulfitos'] },
    ...
    { id: 'p5',  name: 'Agua',              category: 'Bebidas',    price: 1.5,  stock: 60, lowStock: 12, ubicacion: 'Bar',     discount: 0, course: '', allergens: [] },
    { id: 'p6',  name: 'Refresco',          category: 'Bebidas',    price: 2.5,  stock: 50, lowStock: 12, ubicacion: 'Bar',     discount: 0, course: '', allergens: [] },
    { id: 'p7',  name: 'Patatas bravas',    category: 'Tapas',      price: 5.5,  stock: 30, lowStock: 8,  ubicacion: 'Cocina',  discount: 0, course: 'Entrantes', allergens: ['gluten', 'huevos', 'lacteos'] },
    { id: 'p8',  name: 'Croquetas (6u)',    category: 'Tapas',      price: 6.5,  stock: 24, lowStock: 6,  ubicacion: 'Cocina',  discount: 0, course: 'Entrantes', allergens: ['gluten', 'lacteos', 'huevos'] },
    { id: 'p9',  name: 'Calamares',         category: 'Tapas',      price: 8.5,  stock: 20, lowStock: 6,  ubicacion: 'Cocina',  discount: 0, course: 'Entrantes', allergens: ['gluten', 'moluscos'] },
    { id: 'p10', name: 'Jamón ibérico',     category: 'Tapas',      price: 12.0, stock: 15, lowStock: 4,  ubicacion: 'Cocina',  discount: 0, course: 'Entrantes', allergens: [] },
    { id: 'p11', name: 'Pimientos de padrón', category: 'Tapas',    price: 6.0,  stock: 18, lowStock: 5,  ubicacion: 'Cocina',  discount: 0, course: 'Entrantes', allergens: [] },
