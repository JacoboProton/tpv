...
const KTC: Record<string, string> = { base: '#1a1d23', surface: '#252830', surfaceLight: '#30343e', accent: '#c4a04a', accentLight: '#d6b86a', cream: '#e6e1d6', muted: '#9c958a', success: '#7a9a7c', danger: '#b05e5e', line: '#404550' };
...
export default function KDSPairPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const data = await res.json() as { ok: boolean; deviceId: string; tenantId?: string; error?: string };
      if (data.ok) {
