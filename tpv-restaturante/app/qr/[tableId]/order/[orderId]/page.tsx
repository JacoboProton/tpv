...
const STATUS_FLOW: Array<{ status: string; label: string; icon: React.ComponentType<{ className?: string; style?: React.CSSProperties }>; color: string }> = [
...
const ITEM_STATUS_KEYS: string[] = ['sent', 'inPreparation', 'ready', 'served'];
const ITEM_LABELS: string[] = ['Recibido', 'Preparando', 'Listo', 'Servido'];
...
export default function QrOrderTrackingPage() {
  ...
  function getItemStatus(item: OrderItem): number {
